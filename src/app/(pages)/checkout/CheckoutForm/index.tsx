  ...
  const handleSubmit = useCallback(
    async e => {
      ...
      try {
        ...
        const msg = err instanceof Error ? err.message : 'Algo no ha funcionado...'
        setError(`Ocurrió un error al enviar el pago.: ${msg}`)
        setIsLoading(false)
      }
    },
  ...
  return (
    <form onSubmit={handleSubmit} className={classes.form}>
      ...
      <div className={classes.actions}>
        <Button label="Vuelve al carrito" href="/cart" appearance="secondary" />
        <Button
          label={isLoading ? 'Cargando...' : 'Checkout'}
          type="submit"
          appearance="primary"
