  ...
  return (
    <Gutter className={classes.orders}>
      ...
      <div className={classes.itemMeta}>
        <p>{`ID: ${order.id}`}</p>
        <p>{`Intento del Pedido: ${order.stripePaymentIntentID}`}</p>
        <p>{`Fecha del Pedido: ${formatDateTime(order.createdAt)}`}</p>
                  ...
                  <div className={classes.rowContent}>
                    {!stripeProductID && (
                      <p className={classes.warning}>
                        ...
                        >
                          edita este producto en el panel de administración
                        </Link>
                        {'.'}
                      </p>
                    )}
      ...
      <div className={classes.actions}>
        <Button href="/orders" appearance="primary" label="Ver todos los pedidos" />
        <Button href="/account" appearance="secondary" label="Ir a la cuenta" />
      </div>
    </Gutter>
  )
}
